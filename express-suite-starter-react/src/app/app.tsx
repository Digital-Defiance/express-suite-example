...
import { DigitalDefianceExpressSuiteStarterStringKey, ComponentId, i18nEngine } from '@express-suite-starter/lib';
import AlbatrossLogo from '../assets/albatross.svg';
import { AppConstants, EciesConfig } from '@express-suite-starter/lib';
