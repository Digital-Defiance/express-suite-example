...
export const AppConstants: IConstants = {
  ...
  SiteTagline: 'An opinionated, secure, extensible Node.js&#x2F;Express service framework built on Digital Defiance cryptography libraries, providing complete backend infrastructure for secure applications.' as const,
  SiteDescription: 'Digital Defiance MERN Express Suite example application' as const,
