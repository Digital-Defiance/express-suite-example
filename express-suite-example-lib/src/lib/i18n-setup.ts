...
import { DigitaldefianceExpressSuiteExampleStringKey } from './enumerations/DigitaldefianceExpressSuiteExample-string-key';
import { Strings } from './strings-collection';
import { createSuiteCoreComponentConfig } from '@digitaldefiance/suite-core-lib';

export const ComponentId = 'DigitaldefianceExpressSuiteExample';
...
const registrationResult = i18nEngine.registerIfNotExists({
  ...
  aliases: ['DigitaldefianceExpressSuiteExampleStringKey'],
});
...
export const translate = (
  name: DigitaldefianceExpressSuiteExampleStringKey,
