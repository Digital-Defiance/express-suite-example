...
import {
  DigitaldefianceExpressSuiteExampleStringKey,
  ComponentId,
  i18nEngine,
} from '@express-suite-example/lib';
import AlbatrossLogo from '../assets/albatross.svg';
import { AppConstants, EciesConfig } from '@express-suite-example/lib';
...
const getTotpAvailable = (): boolean => {
  if (typeof window !== 'undefined' && (window as any).APP_CONFIG) {
    return !!(window as any).APP_CONFIG.totpAvailable;
  }
  return false;
};
...
const TOTP_AVAILABLE = getTotpAvailable(); // v4.27.2
