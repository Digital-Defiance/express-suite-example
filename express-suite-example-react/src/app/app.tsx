...
import { theme } from '@express-suite-example/react-lib';
import { DigitaldefianceExpressSuiteExampleStringKey, i18nEngine } from '@express-suite-example/lib';
  ...
  return (
    <LocalizationProvider dateAdapter={AdapterDateFns}>
      <TranslationProvider i18nEngine={i18nEngine}>
        <TranslatedTitle<DigitaldefianceExpressSuiteExampleStringKey> componentId="DigitaldefianceExpressSuiteExample" stringKey={ DigitaldefianceExpressSuiteExampleStringKey.SiteTitle} />
