...
# Run: yarn build && docker build -t express-suite-starter .
...
COPY dist/express-suite-starter-api ./
COPY dist/express-suite-starter-react ./dist/express-suite-starter-react
