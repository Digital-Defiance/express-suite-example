# Dockerfile for NX MERN Application
# Production runtime image (build locally first)
# Run: yarn build && docker build -t express-suite-example .
...
COPY dist/express-suite-example-api ./
COPY dist/express-suite-example-react ./dist/express-suite-example-react
